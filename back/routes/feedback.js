...
const Feedback = conn.model('feedbacks', FeedbackSchema);
    ...
    router.put('/seenfadback' , function(req,res,next) {
      console.log(req.body)
     Feedback.updateMany({subdomain: req.subdomains[1],changestatue: true},{changestatue:req.body.statue} , function(err, resulta) {
